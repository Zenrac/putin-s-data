...
CLIENT_ID = "85f382ae268ad27"
CLIENT_SECRET = "1a6e575c50422848d39258f45ab461de7d15bbd3"
...
class Image:
    ...
    @commands.group(name="imgur", no_pm=True, hidden=True)
    async def _imgur(self, ctx):
        """Retrieves pictures from imgur"""
        test='test'

    @_imgur.command(name="random")
    async def imgur_random(self, ctx, *, term: str=None):
        ...
        try:
            ...
            await ctx.send("Error: request timed out")
        else:
            if results:
                item = choice(results)
    ...
    @_imgur.command(hidden=True,name="subreddit")
    ...
    async def gif(self, ctx, *keywords):
        ...
        if keywords:
            ...
            await ctx.send('I need some keywords to search with.')
            return
    ...
    async def gifr(self, ctx, *keywords):
        ...
        if keywords:
            ...
            await ctx.send('You need to give me some keywords.')
            return
